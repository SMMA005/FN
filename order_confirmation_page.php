...
<div class="order-confirmation-container">
    ...
    <div class="order-confirmation-sub-container order-confirmation-sub-container-paragraph">
        <p><strong> Hey <span>Muzaffar</span> ! </strong>Your order has been placed succesfully !</p>
        <p><strong>Product:</strong><span id="product_name">INFITNITY ASOUS ROUGE X11</span>.</p>
